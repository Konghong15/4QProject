...
namespace Rgph
{
	...
	public:
			...
			: FullScreenPass(graphics, std::move(name))
		{
			...
			mShaderInputRTV1 = std::make_shared<ShaderInputRenderTarget>(graphics, textureWidth, textureHeight, 10, DXGI_FORMAT_R16G16B16A16_FLOAT);
			...
			// ºäÆ÷Æ®
			AddBind(std::make_shared<Viewport>(graphics, textureWidth, textureHeight));
