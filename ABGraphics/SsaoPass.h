...
namespace Rgph
{
	...
	public:
			...
			: BindingPass(std::move(name))
		{
			...
			mSsaoMap = std::make_shared<ShaderInputRenderTarget>(graphics, textureWidth, textureHeight, 10, DXGI_FORMAT_R16G16B16A16_FLOAT);
			...
			AddBind(Bind::Sampler::Create(graphics, Sampler::Type::Point, D3D11_TEXTURE_ADDRESS_BORDER, 0));
			AddBind(Bind::Sampler::Create(graphics, Sampler::Type::Point, false, 1));
